...
import net.craftenergy.content.world.RubberTreeGrower;
...
public class RubberSaplingBlock extends SaplingBlock {
    ...
    public void advanceTree(ServerLevel level, BlockPos pos, BlockState state, RandomSource random) {
        ...
        for (int i = 0; i < height; i++) {
            ...
            if (level.isEmptyBlock(trunkPos) || level.getBlockState(trunkPos).canBeReplaced()) {
                ...
                level.setBlock(trunkPos,
                        net.craftenergy.content.CEBlocks.RUBBER_LOG.get().defaultBlockState()
        ...
        BlockState leavesState = net.craftenergy.content.CEBlocks.RUBBER_LEAVES.get().defaultBlockState();
